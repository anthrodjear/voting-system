      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b border-neutral-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-ro-50">
              <ShieldCheckIcon className="w-6 h-6 text-ro-500" />
            </div>
            {!sidebarCollapsed && (
              <div>
                <h1 className="text-lg font-bold text-neutral-900">IEBC</h1>
                <p className="text-xs text-neutral-500">RO Portal</p>
              </div>
            )}
          </div>
        </div>
        ...
        {!sidebarCollapsed && (
          <div className="px-4 py-3 border-b border-neutral-100">
            <div className="flex items-center gap-2 px-3 py-2 bg-ro-50 rounded-lg">
              <MapPinIcon className="w-4 h-4 text-ro-500" />
              <span className="text-sm font-medium text-ro-700">{county} County</span>
            </div>
          </div>
        )}
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-ro-100 text-ro-700'
                    : 'text-neutral-600 hover:bg-ro-50 hover:text-ro-700',
                  sidebarCollapsed ? 'justify-center' : ''
                )}
                title={sidebarCollapsed ? item.label : undefined}
              >
                <span className={isActive ? 'text-ro-500' : 'text-neutral-400'}>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-neutral-200">
              <div className="text-right">
                ...
                <p className="text-xs text-neutral-500">Returning Officer</p>
              </div>
              <button 
                onClick={handleLogout}
                className="w-10 h-10 rounded-full bg-ro-100 flex items-center justify-center text-ro-600 font-semibold hover:bg-ro-200 transition-colors"
                title="Sign out"
              >
