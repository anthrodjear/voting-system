      ...
      >
        <div className="h-20 flex items-center px-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-orange-400 to-amber-600 flex-shrink-0 shadow-lg shadow-orange-500/20">
              <ShieldCheckIcon className="w-7 h-7 text-white" />
            </div>
            {!sidebarCollapsed && (
              <div className="min-w-0">
                <h1 className="text-xl font-bold text-white">IEBC</h1>
                <p className="text-xs text-orange-400/70">Voter Portal</p>
              </div>
            )}
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? 'bg-gradient-to-r from-orange-500/20 to-amber-500/10 text-orange-400 border border-orange-500/20' : 'text-white/50 hover:text-white hover:bg-white/5',
                  sidebarCollapsed ? 'justify-center px-3' : ''
                )}
                title={sidebarCollapsed ? item.label : undefined}
              >
                <item.icon className={cn('w-6 h-6 flex-shrink-0', isActive ? 'text-orange-400' : '')} />
        ...
        <div className="absolute bottom-20 left-0 right-0 px-3 space-y-1">
          ...
          <button 
            ...
            className={cn(
              'flex items-center gap-3 px-4 py-3 rounded-xl w-full text-white/50 hover:text-red-400 hover:bg-red-500/10 transition-all duration-200',
              sidebarCollapsed ? 'justify-center px-3' : ''
            )}
          >
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-white/5">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs text-white/30">Voter</p>
              </div>
              <button onClick={handleLogout} className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500/20 to-amber-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 font-semibold">
